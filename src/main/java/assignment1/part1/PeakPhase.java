 ...
 */
public class PeakPhase implements Runnable {
     ...
     * @param numLifts
     */
    public PeakPhase(CloseableHttpClient httpClient, int num_threads, int numSkiers, String url, int numLifts) {
    ...
    public PeakPhase(CloseableHttpClient httpClient, String url) {
        this.httpClient = httpClient;
        this.url = url;
    }
...
//            }
     ...
     * @return
     */
    private boolean resendRequest(HttpPost request) throws IOException, InterruptedException {
        return true;
//        int count = 5;
//        int status;
//
